...
import com.example.musicapp.databinding.DialogNouserBinding


class CustomDialogNoUser : DialogFragment()  {
    ...
    override fun onCreateView(
        ...
        return DialogNouserBinding.inflate(inflater, container, false)
            .also {
                it.headline.run {
                    append(textStyle)
                }
