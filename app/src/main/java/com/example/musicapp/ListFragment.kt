...
class ListFragment : Fragment() {
    ...
    val song1 = RockType(
        ...
        "With their raw, energetic and distorted sound Mäneskin" +
                ...
                " rock 'n' roll for a new generation of listeners.",
    ...
    val song2 = RockType(
        ...
        "Arctic Monkeys is an indie rock band formed" +
                ...
                "Nick O'Malley (backing vocals, bass) and Matt Helders (drums, vocals).",
    ...
    val song3 = PopType(
        ...
        "Lana Del Rey is an American singer, songwriter and record producer, whose real name" +
                ...
                " for her melancholic style of pop music.",
    ...
    val song4 = RockType(
        ...
        "Hailing from Southend-on-Sea in Essex, England, Nothing But Thieves make" +
                ...
                " indie rock artfulness with a pop sensibility.",
    ...
    val song5 = PopType(
        ...
        "The Neighbourhood (sometimes rendered as \"THE NBHD\") is an American alternative" +
                ...
                " and bassist Mikey Margott. They are currently signed to Columbia Records.",
        "${R.drawable.img_24},${R.drawable.img_25},${R.drawable.img_26}"
    )
    val song6 = RockType(
        6, "hometown", "cleopatrick", R.drawable.pic6, "424 853",
        "guitar band", "${R.drawable.img_27},${R.drawable.img_28}"
    )
    val song7 = RockType(
        7, "Figure It Out", "Royal Blood", R.drawable.pic7, "2 897 523",
        ...
        "${R.drawable.img_29},${R.drawable.img_30}"
    )
    ...
    val song8 = PopType(
        ...
        R.drawable.pic8,
        "10 180 405",
        "Alt-J (stylised as alt-J, real name Δ) are an English" +
                ...
                " and formerly Gwil Sainsbury (guitar/bass).",
        "${R.drawable.img_31},${R.drawable.img_32}"
    )
    val song9 = PopType(
        9, "Umbrella", "Rihanna", R.drawable.pic9, "84 555 520",
        ...
        "${R.drawable.img_33},${R.drawable.img_34},${R.drawable.img_35}"
    ) //
    val song10 = PopType(
        10,
        "Toxic",
        ...
        "${R.drawable.img_36},${R.drawable.img_37},${R.drawable.img_38}"
    )
    val song11 = PopType(
        11,
        "Hits Different",
    ...
    val song12 = RapType(
        ...
        "Eminem is an American rapper, songwriter," +
                ...
                " solo career, Eminem was a member of the hip hop group D12.",
    ...
    val song13 = RapType(
        ...
        "Kendrick Lamar Duckworth (born June 17, 1987) is an American " +
                ...
                " and jazz genres to be awarded the Pulitzer Prize for Music.",
        "${R.drawable.img_44},${R.drawable.img_45}"
    )
    val song14 = RapType(
        14,
        "Agora Hills",
        ...
        "Amala Ratna Zandile Dlamini (Zulu pronunciation: [ˈzandile ˈɮamini];" +
                ...
                " She began making and releasing music on SoundCloud as a teenager.",
        "${R.drawable.img_46},${R.drawable.img_47}"
    )
    ...
    val rock = arrayOf(song1, song2, song4, song6, song7, song15)
    val pop = arrayOf(song3, song5, song8, song9, song10, song11)
    val rap = arrayOf(song12, song13, song14, song16)
    ...
    private fun getDataSongsList(keyword: String) {
        ...
        if (musicType == "Rock") {
            binding.recyclerView.adapter = adapterRock
            binding.actvSearch.setAdapter(adapterAutoCompleteRock)
            ...
            binding.actvSearch.setAdapter(adapterAutoCompletePop)
            ...
            binding.recyclerView.adapter = adapterRap
            binding.actvSearch.setAdapter(adapterAutoCompleteRap)
