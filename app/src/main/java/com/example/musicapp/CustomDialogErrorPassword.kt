...
import com.example.musicapp.databinding.FragmentDialogErrorPasswordBinding

class CustomDialogErrorPassword : DialogFragment()  {
    ...
    override fun onCreateView(
        ...
        return FragmentDialogErrorPasswordBinding.inflate(inflater, container, false)
            .also {
                it.headline.run {
                    append(textStyle)
                }
